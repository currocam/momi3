...
class NumHessian:
    ...
    def loglik_for_numdiff(self, val, paths, X_batch, sfs_batch):
    ...
    def numerical_FIM_uncert(self, X_batch, sfs_batch, num_steps=10):
        diag_FIM = self.numerical_diag_of_hessian(
            X_batch, sfs_batch, num_steps=num_steps
        )
